...
<figure>
<img src="../../res/forme-onde.jpg" class="mx-auto d-block" width="100%">
</figure>
...
Mesurez la durée de l'attaque et du release du son de piano suivant en secondes : [piano.wav](../res/piano.wav).

## Spectre d'un son (6 pt)

Mesurez la fréquence, l'amplitude en dB et la durée approximative en secondes des 13 premiers partiels du son suivant : [piano.wav](../res/piano.wav).
...
## Synthétiser un son à partir de son analyse (4 pt)
